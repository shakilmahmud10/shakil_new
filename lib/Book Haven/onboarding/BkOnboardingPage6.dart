...
import 'package:shakil_new/Book%20Haven/onboarding/BkOnboardingPage7.dart';
import '../../Core Components/colors.dart';
import '../../Core Components/style.dart';
import '../../Core Components/text_style.dart';
import '../../Core Components/images.dart';

class BkOnboardingPage6 extends StatefulWidget {
  const BkOnboardingPage6({super.key});

  @override
  State<BkOnboardingPage6> createState() => _BkOnboardingPage6State();
}

class _BkOnboardingPage6State extends State<BkOnboardingPage6>
