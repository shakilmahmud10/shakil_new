...
class TopPreviewWidget extends StatelessWidget {
  ...
  List<Widget> _buildSmallCircles(Size size) {
    ...
    final positions = [
      ...
      {'top': size.height * 0.13, 'right': size.width * 0.58, 'size': 40.0},
      ...
      {'top': size.height * 0.3, 'left': size.width * 0.46, 'size': 15.0},
    ];
  ...
  Widget _buildSingleIconContent() {
    return Container(
      ...
      child: SvgPicture.asset(onboardingImage3, height: 120),
    );
  }
}
