...
import 'BkOnboardingPage2.dart';

class BkOnboardingPage1 extends StatefulWidget {
  const BkOnboardingPage1({super.key});

  @override
  State<BkOnboardingPage1> createState() => _BkOnboardingPage1State();
}

class _BkOnboardingPage1State extends State<BkOnboardingPage1>
