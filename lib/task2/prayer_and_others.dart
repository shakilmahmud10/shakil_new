            ...
            child: Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  childAspectRatio: 1.3,
                  children: const [
                    PrayerAndOthersCard(icon: othersIcon1, text: 'Quran Mazid'),
                    PrayerAndOthersCard(
                      icon: othersIcon2,
                      text: 'Dua & Ruqyah',
                    ),
                    PrayerAndOthersCard(icon: othersIcon3, text: 'Al Hadith'),
                    PrayerAndOthersCard(icon: othersIcon4, text: 'Musaf Mode'),
                    PrayerAndOthersCard(icon: othersIcon5, text: 'Masayel'),
                    PrayerAndOthersCard(
                      icon: othersIcon6,
                      text: 'Salah Tracker',
                    ),
                    PrayerAndOthersCard(icon: othersIcon7, text: '99 Names'),
                    PrayerAndOthersCard(
                      icon: othersIcon8,
                      text: 'Qibla Finder',
                    ),
